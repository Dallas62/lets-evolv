...
module.exports = testCase({
    'Perceptron - Instantiation': function PerceptronInstantiation(test) {
        // Instantiation
        var perceptron = new Perceptron(2, Activation.heaviside);
    ...
    'Perceptron - NOT logic gate': function PerceptronNOTLogicGate(test) {
        // Instantiation
        var perceptron = new Perceptron(1, Activation.heaviside);
    ...
    'Perceptron - XOR logic gate using 3 perceptrons': function PerceptronXORLogicGateUsing3Perceptrons(test) {
        // Instantiation
        var or = new Perceptron(2, Activation.heaviside);
        var and = new Perceptron(2, Activation.heaviside);
        var not = new Perceptron(2, Activation.heaviside);
